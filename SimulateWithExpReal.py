...
Metro=mp3.multiMetropolis(3000,None,[0.4,0.1,0.3],None,InitialGP,GPDoc,estimate.GaussianStandardPriorGP,"Change","c")
...
Metro.saveResult("TrueValueGradient200k","ConstantGradient200k")
'''
