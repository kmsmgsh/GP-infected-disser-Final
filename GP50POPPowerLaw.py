...
population=50
model1=gc2.heteregeneousModel(population,[300,0.01,1.5,0.3],True,True,"powerlaw")
model1.Animate()
...
Metro=mp3.multiMetropolis(30000,None,[0.4,0.1,0.3],None,InitialGP,GPDoc,estimate.GaussianStandardPriorGP,"Change","c",30000)

gp.kernelFunctonPlot(model1.DistanceMatrix,Metro.recordGP,Metro.record,"gradient")
gp.kernelFunctonPlotRebuild(model1.DistanceMatrix,Metro.recordGP,[0.4,0.1,0.3],"powerlaw",[300,0.01,1.5,0.3],InitialGP)
...
Metro.saveResult("TrueValueGradient30kRandomWalk","ConstantGradient30kRandomWalk")
